    ...
    <div class="card shadow-lg border-0">
        ...
        <div class="card-header bg-primary text-white text-center py-3">
            ...
            <p class="mt-2 mb-0" style="font-size:14px; opacity:0.9;">
                จัดทำโดย: พิชญาณัฏฐ์ รินทร์วงค์ (อินเตอร์)
            </p>
        </div>
...
<?php
        if(isset($_POST['Submit'])){
            ...
            $sql = "INSERT INTO Application (a_id, a_position, a_prefix, a_fullname,a_birthday,a_education,a_skills,a_experience ) VALUES (NULL, '{$position}', '{$prefix}', '{$fullname}', '{$birthday}', '{$education}', '{$skills}', '{$experience }')";
